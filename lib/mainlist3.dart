...
class MainList3 extends StatefulWidget {
  @override
  _MainList3State createState() => _MainList3State();
}

class _MainList3State extends State<MainList3>
  ...
  Widget homePageCard(Color color, Image image, String title,
